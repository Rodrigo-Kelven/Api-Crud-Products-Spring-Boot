...
import com.project.base.services.ProductService;

import com.project.base.dtos.*;
...
@Tag(name = "API Product", description = "Endpoints of Products.")
public class ProdutoController {
    ...
    public ResponseEntity<List<Product>> listarProdutoController() {
    ...
    public ResponseEntity<ResponseEntity<Product>> criarProdutoController(
            @Parameter(description = "Dados do Produto", required = true)
            @Valid @RequestBody ProductRequestDTO productRequestDTO) {

        // Chama o serviço para criar o produto
        ResponseEntity<Product> product = service.createProdutoService(productRequestDTO);

        // Retorna a resposta com o status 200 (OK) e o Product
    ...
    public ResponseEntity<Product> buscarProdutoByIdController(
    ...
    public ResponseEntity<Product> atualizarProdutoByIdController(
    		@Parameter(description = "ID do Produto a ser atualizado.", required = true) 
    		@PathVariable(required = true) UUID id,
    		@RequestBody ProductRequestDTO produtoAtualizado ) {
